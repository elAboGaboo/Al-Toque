    ...
    return Scaffold(
      ...
      body: partidoAsync.when(
        ...
        data: (partido) {
          ...
          // Si el partido se completÃ³, navegar a completado
            ...
            IconButton(
              ...
              onPressed: () {
                ...
                SharePlus.instance.share(
                  ShareParams(text: 'Â¡Ãšnete a mi partido de ${partido.deporteLabel} en Huancayo!\n'
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Cuando el partido se llene, la IA reservarÃ¡ automÃ¡ticamente la mejor cancha disponible.',
                            style: GoogleFonts.outfit(
                              fontSize: 13,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(
                            'mÃ¡x S/${partido.precioMaxPorJugador.toStringAsFixed(0)}',
                            style: GoogleFonts.bricolageGrotesque(
                              fontSize: 16,
                              fontWeight: FontWeight.w700,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Se uniÃ³ ${AppDateUtils.fechaRelativa(jugador.unidoEn)}',
                  style: GoogleFonts.outfit(
                    fontSize: 11,
