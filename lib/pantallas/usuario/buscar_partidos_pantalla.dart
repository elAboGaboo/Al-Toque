...
import '../../componentes/comunes/cargando_esqueleto.dart';
import '../../proveedores/ubicacion_proveedor.dart';
              ...
              data: (partidos) {
                if (partidos.isEmpty) {
                  return EmptyStateWidget(
                    ...
                    subtitulo:
                        'SÃ© el primero en armar uno en Huancayo',
                    emoji: 'âš½',
            ...
            child: ubicacionAsync.when(
              data: (pos) {
                ...
                return direccionAsync.when(
                  ...
                  loading: () => const Text('Obteniendo direcciÃ³n...'),
                  error: (_, _) => const Text('UbicaciÃ³n actual'),
                );
              },
              loading: () => const Text('Buscando GPS...'),
              error: (_, _) => const Text('Huancayo, PerÃº'),
            ),
          ),
